 ...
 * <p>
 * <h1>Example:</h1>
 * PersianDateFormat pdformater1 = new PersianDateFormat("Y/m/d");<br>
 * PersianDateFormat pdformater2 = new PersianDateFormat("y F j");<br>
 * <p>
 * PersianDate pdate1 = new PersianDate();<br>
 * pdate1.initGrgDate(2012, 1, 8);<br>
 * String result = pdformater1.format(pdate1) ;<br>
 * <p>
 * PersianDate pdate6 = new PersianDate();<br>
 * String result = pdformater1.format(pdate6) ;<br>
 */
...
public class PersianDate {
    ...
    private String[] monthNames = {"قروردین", "اردیبهشت", "خرداد", "تیر", "مرداد", "شهریور", "مهر", "آبان", "آذر", "دی", "بهمن", "اسقند"};
    ...
    /**
     * initilize onlineDate from jallai onlineDate
     *
     * @param year  Year in jallali onlineDate
     * @param month Month in Jallali onlineDate
     * @param day   daye in Jalalli onlineDate
     * @return
     */
    ...
    /**
     * Helper function for initilize jalali onlineDate
     *
     * @param year
     * @param month
     * @param day
    ...
    /**
     * Convert Grg onlineDate to jalali onlineDate
     *
     * @param year  year in Grg onlineDate
     * @param month month in Grg onlineDate
     * @param day   day in Grg onlineDate
     * @return a int[year][month][day] in jalali onlineDate
     */
    ...
    /**
     * Convert Jalali onlineDate to Grg
     *
    ...
    /**
     * Return Day in difreent onlineDate
     *
     * @return
     */
    ...
    /**
     * Return difreent just day in copare 2 onlineDate
     *
     * @param date onlineDate for compare
     * @return
     */
    ...
    /**
     * Calc difreent onlineDate until now
     *
     * @return
     */
    ...
    /**
     * calcute diffrent between 2 onlineDate
     *
     * @param date Date 1
     * @return
     */
    ...
    /**
     * convert PersianDate class to onlineDate
     *
     * @return
     */
    public Date toDate() {
    ...
    public String toString() {
        PersianDateFormat formater = new PersianDateFormat("Y/m/d");
